...
const cacheUrls = [
    ...
    'views/SubscribeView/SubscribeView.ts',
    'views/SubscribeView/SubscribeView.hbs',
    'views/SubscribeView/SubscribeView.scss',
    ...
    'components/ChatRoom/ChatRoom.hbs',
    'components/ChatRoom/ChatRoom.scss',
